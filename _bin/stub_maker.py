...
# CSV MUST be in the format title, YY_YY, period, show_type_sort, show_type, playwright, date_start, date_end, content
...
def make_template(title, period, sort, show_type, playwright, date_start, date_end, content):
    return """---
title: \"""" + title + """\"
